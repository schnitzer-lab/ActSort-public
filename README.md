...
## Citations
For details of implementation, please see [bioRxiv paper](https://www.biorxiv.org/content/10.1101/2024.08.21.609011v1.abstract) [NeurIPS paper](https://proceedings.neurips.cc/paper_files/paper/2024/file/90080022263cddafddd4a0726f1fb186-Paper-Conference.pdf)

Jiang, Y., Akengin, H. O., Zhou, J., Aslihak, M. A., Li, Y., Chrapkiewicz, R., Hernandez, O., ... & Dinc, F., Blanco-Pozo, M., Schnitzer, M. J. (2024). ActSort: An active-learning accelerated cell sorting algorithm for large-scale calcium imaging datasets. bioRxiv, 2024-08. (Published in NeurIPS 2024)

```bibtex
@inproceedings{jiang2024actsort,
  title={ActSort: An active-learning accelerated cell sorting algorithm for large-scale calcium imaging datasets},
  author={Jiang, Y., Akengin, H. O., Zhou, J., Aslihak, M. A., Li, Y., Chrapkiewicz, R., Hernandez, O., Ebrahimi, S., Jaidar, O., Zhang, Y., Inan, H., Miranda, C., Dinc, F., Blanco-Pozo, M., Schnitzer, M. J.},
